            ...
            <div class="w-9/12 mx-2">
                <div id="slider" class="">
                    <div class="slider-text">
                        ...
                        <div style="background-image: url({{$gallery->name}});" class="single-slider-item bg-cover bg-center h-64">test</div>
                        @endforeach
                    ...
                    @foreach($property->gallery as $gallery)
                        <div style="background-image: url({{$gallery->name}});" class="single-thumbnail-item bg-cover bg-center h-48">test</div>
                        @endforeach
                    </div>
